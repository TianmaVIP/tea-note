...
<body onload="focusName()" bgcolor="#edf2f8">
   <div class="main">
      <div class="top"><a href="http://www.bgy.org.cn"><img src="images/logo.png"/></a></div>
      <div class="mid">
		  ...
		  <form method="post" action="ChkLogin.php">
	             <div class="row">
		            <input class="input-txt-row" type="text" tabIndex = "1" id="user_name" name="username" value="学号/职工号/" onFocus="focusUserName()" onblur="leaveUserName()" onKeyDown="enterPassword(event)" onMouseOver="changeBorderColor(this)" onMouseOut="backBorderColor(this)" onChange="showOrHideSmsCode()"/>
	            ...
	            <div id="passwd_area" class="row">
		        	<input class="input-txt-row input-txt-pad"  type="password" tabIndex = "2"  id="password" name="userpwd"  value="密码" onFocus="focusPassword()" onblur="leavePassword()" onKeyDown="enterSMSCode(event)" onMouseOver="changeBorderColor(this)" onMouseOut="backBorderColor(this)"/>
      ...
      <div class="bottom">
         <!--<img src="./resources/images/bdxxfw.jpg" width="86"/>
      	--><div class="lx_info">
         	<span>版权所有</span>
            <span>Email：<a href="bgy.org.cn">bgy.org.cn</a></span>
        	<span>© <a href="http://www.bgy.org.cn/">北京工业职业技术学院</a></span>
        </div>
      </div>
   </div>
</body>
