...
//$tea_name1=$_GET['tea_name'];
//$tea_term1=$_GET['tea_term'];
$sql="select * from tb_teachinginfo where tea_name like '%$tea_name%' and tea_cou like '%$tea_cou%' and tea_class like '%$tea_class%' and tea_term like '%$tea_term%' order by tea_id asc";
//echo $sql;
//}else{
...
echo "</select>";
echo "</td>";
echo "<td><input type='submit'   value='修改'/><a href='deleteTeachingPlan.php?tea_id=$tea_id&tea_term=$tea_term1&tea_name=$tea_name1' onclick='return del()'>删除</a></td>";
echo "</tr>";
echo "</form>";
$j=$i+1;
		}
...
?>
  ...
  <tr>
      <td align="center"><a href="modify.php? p=0"><font color="#FF0000">首页</font></a></td>
