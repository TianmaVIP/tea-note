...
<table align="center">
     <tr>
         ...
         <td><a href="../tea/SearchCourse.php">查询课程</a></td>
         <td><a href="AddCourse.php">添加课程</a></td>
         <td><a href="../login.php">退出系统</a></td>
     </tr>
</table>
<table width="620" border="0" align="center" cellpadding="0" cellspacing="1">
     <tr bgcolor="#0066CC">
         ...
         <td width="100" align="center"><font color="#FFFFFF" align="center">操作</font></td>
     </tr>
<?php
	...
	for($i=0;$i<$number;$i++){
		...
		if($i>=$p && $i < $check){
			if($i%2 ==0)
			  ...
			  echo"<td width='40'><a href='ModifyCourse.php? CouNo=".$row['CouNo']."'>修改</a>   <a href='DeleteCourse1.php? CouNo=".$row['CouNo']."'>删除</a></td>";
			  echo"</tr>";
			  $j=$i+1; 
		 }
		}
